...
ZumoBuzzer buzzer;
QTRSensorsAnalog reflectanceSensors((unsigned char[]) {0, 1, 2, 3, 4, 5}, 
...
//            found_straight = 1;
        ...
        // solved the maze.
        //######################Finish condition
        if(ABOVE_LINE(sensors[0]) && ABOVE_LINE(sensors[5]) && !ABOVE_LINE(sensors[2]) && !ABOVE_LINE(sensors[3]))
        {
          motors.setSpeeds(0,0);
          break;
        }
